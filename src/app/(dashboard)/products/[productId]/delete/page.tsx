        ...
        return (
            <div id={styles.container}>
                <div id={styles.wrapper}>
                    ...
                    <span id={styles.text}>Please type in "{product.name}" of the product to continue.</span>
                    ...
                    <div id={styles.buttonContainer}>
                        ...
                        <Button theme='danger' text='Delete' onClick={() => { }} type='button' loading={product.name !== input} />
                    </div>
                </div>
            </div>
        )
